  ...
  do
    ...
    do
      ...
      do
        ...
        do
          {
            EXTRA_ARGS="--aug-cond crop color flip blur grayscale --base-lr ${CUR_LR} --wd 1e-4 --ckpt-freq ${FREQ} --eval-freq ${FREQ} --num-workers 16"
            SUFFIX="crop_color_all"
