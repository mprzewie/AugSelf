...
do
  ...
  do
    ...
    do
      ...
      do
        {
          EXTRA_ARGS="--aug-cond crop color flip blur grayscale --base-lr 0.05 --wd 1e-4 --ckpt-freq ${FREQ} --eval-freq ${FREQ} --num-workers 16 --distributed"
          SUFFIX="cropcolflipblurgray"
