# ADAPTED FROM https://raw.githubusercontent.com/facebookresearch/moco/main/main_lincls.py
# MoCo and LOOC-like evaluation
...
parser.add_argument("--dataset-name", choices=["imagenet100", "cub200"], required=True)
parser.add_argument(
    "-a",
    "--arch",
    metavar="ARCH",
...
def sanity_check(state_dict, pretrained_weights):
    ...
    state_dict_pre = checkpoint["backbone"]
    ...
    for k in list(state_dict.keys()):
        ...
        assert (
            state_dict[k].cpu() == state_dict_pre[k.replace("module.", "")]
